...
void BarResonance::render(int width, int height, int tick, float fade,
    ...
    float slot = kResonanceBarWidth + kResonanceBarSpacing;
    int bar_count = static_cast<int>(
        (static_cast<float>(width) - kResonanceBarSpacing) / slot);
    ...
    int band_h = static_cast<int>(kResonanceBarHeightRatio *
